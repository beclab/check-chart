...
var (
	...
	AppCfgInfoEmtpyFromMain = "The info of TerminusManifest.yaml from the main branch is empty."
	AppCfgReadFailed        = "Failed to read TerminusManifest.yaml in folder [%s]: [%v]"
	AppCfgParseFailed       = "Failed to parse TerminusManifest.yaml in folder [%s]: [%v]"

	DbErr = "db err[%s]"

	//chart invalid
	InvalidAppCfgType            = "terminusManifest.type %s invalid, must in %v"
	...
	ApiVersionFieldEmptyInAppCfg = "apiVersion field empty in TerminusManifest.yaml in chart '%s'"
	NameFieldEmptyInAppCfg       = "name field empty in TerminusManifest.yaml in chart '%s'"
	VersionFieldEmptyInAppCfg    = "version field empty in TerminusManifest.yaml in chart '%s'"
	MissingValuesYaml            = "missing values.yaml in folder: '%s'"
	MissingTemplatesFolder       = "missing templates folder in folder: '%s'"
	MissingAppCfg                = "missing TerminusManifest.yaml in folder: '%s'"
	ReadAppCfgFailed             = "failed to read TerminusManifest.yaml in folder '%s': %v"
	ParseAppCfgFailed            = "failed to parse TerminusManifest.yaml in folder '%s': %v"
	NameMustSame1                = "inconsistent info. name must be the same in chart. name in Chart.yaml:%s, chartFolder:%s, TerminusManifest.yaml:%s"
	NameMustSame2                = "inconsistent info. name must be the same in chart. name in Chart.yaml:%s, chartFolder:%s, folder in title:%s, TerminusManifest.yaml:%s"
	VersionMustSame1             = "inconsistent info. Version must be the same in chart. version in TerminusManifest.yaml:%s, Chart.yaml:%s"
	VersionMustSame2             = "inconsistent info. Version must be the same in chart. version in TerminusManifest.yaml:%s, Chart.yaml:%s, title:%s"
